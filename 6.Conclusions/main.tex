...
techniques discussed in \secref{chap:ape} might prove useful to leverage
monolingual data. In line with the work discussed in
\secref{chap:adaptsparse}, we hope to use sparsity in our models to
...
as discussed in \secref{chap:sparsemarg}.
