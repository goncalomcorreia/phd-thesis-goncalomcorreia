...
influential work present in this thesis. It is part of a line of work
that sparked interest in the topic of making Transformers more
efficient through sparsity (blabla, inter alia), using sparsity to
allow for Transformers to use longer contexts more effecively
(blabla, inter alia), and having Transformers with easier
interpretability and more transparency (blabla, inter alia). It is
also part of a growing line of work surrounding sparse probability
distributions (blabla, inter alia).
