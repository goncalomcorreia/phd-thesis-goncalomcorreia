...
bisection algorithm for computing $\alpha$-\entmaxtext. Given the
impact of our work, we believe that approaches that sparsify
Transformers will continue to increase in the future, with the
objective of improving the architecture's efficiency and
transparency.
