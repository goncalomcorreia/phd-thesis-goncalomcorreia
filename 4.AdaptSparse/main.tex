...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.66\columnwidth]{Figures/comparison.pdf}
...
\section{Related Work}\label{sec:related_adapt}
...
\begin{wrapfigure}[15]{r}{0.5\columnwidth}
    \centering
    \includegraphics[width=0.5\columnwidth]{Figures/learning_alpha.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\columnwidth]{Figures/hist_alphas.pdf}
    \caption{%
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\columnwidth]{Figures/hist_densities.pdf}
    \caption{%
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\columnwidth]{Figures/head_density_per_layer.pdf}
    \caption{%
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\columnwidth]{Figures/js_divs.pdf}
    \caption{%
        \label{fig:js_divs}
...
The statistics shown in this section can be found for the other
language pairs in \appref{app:plots_lps}.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\columnwidth]{Figures/head_prev.pdf}
    \caption{
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\columnwidth]{Figures/head_bpe}
...
\begin{figure}[t]
    \centering
    \includegraphics[
        width=0.6\columnwidth]{Figures/sparsity_difference.pdf}
    \caption{%layer 5+1 / head 6+1, alpha=1.33.
