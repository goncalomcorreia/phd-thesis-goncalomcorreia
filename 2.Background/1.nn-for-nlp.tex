...
A recently attractive way to obtain high-performing models in NLP is
...
encoder building block, and thus not having language modeling
capabilities in its \textit{vanilla} form. As other similar models,
BERT was trained on an enormous corpus of sentences, on both
monolingual english datasets and multilingual datasets of 100+
languages. Many studies have analysed the BERT model and came up with
variants for it, and its study has even been referred as
