...
\newgeometry{top=2.5cm, bottom=2.5cm, inner=2.0cm, outer=2.0cm}
\input{0.Preliminaries/1.cover_EN_final.tex}
\cleardoublepage
\input{0.Preliminaries/1.cover_EN_final_first_page.tex}
...
\begin{appendices}
    \begin{appendix}
        ...
        \input{Appendices/resources.tex}
        \cleardoublepage
    \end{appendix}
\end{appendices}
