\begin{abstract}
        ...
        architecture compared to conventional normalization
        functions. Finally, for \textbf{compactness}, we reveal a way
        to efficiently obtain deterministic gradients of discrete and
        structured latent variable models. The discrete nodes in
        ...
        propose to train these models with exact gradients by
