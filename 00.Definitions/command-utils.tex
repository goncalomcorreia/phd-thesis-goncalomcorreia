...
\newcommand{\delang}{{\fonttextsc \textsc{de}}\xspace}
\newcommand{\enlang}{{\fonttextsc \textsc{en}}\xspace}
\newcommand{\rolang}{{\fonttextsc \textsc{ro}}\xspace}
\newcommand{\jalang}{{\fonttextsc \textsc{ja}}\xspace}
\newcommand{\langp}[2]{{\fonttextsc \textsc{#1}}$\shortrightarrow${\fonttextsc \textsc{#2}}}
\newcommand{\langpb}[2]{{\fonttextsc \textsc{#1}}$\leftrightarrow${\fonttextsc \textsc{#2}}}
\newcommand{\tr}{\top}
\newcommand{\amap}{\bm{\pi}}
\newcommand{\HHs}{\mathsf{H}^{\fonttextsc \textsc{S}}}
\newcommand{\HHt}{\mathsf{H}^{{\fonttextsc \textsc{T}}}}
\newcommand{\ones}{\bm{1}}
...
\newenvironment{definition}[1][]{%
    ...
    {\mdfsetup{%
            frametitle={%
                    ...
                    {\strut\fonttextsc Definition~\thedefinition};}}
    }%
    {\mdfsetup{%
            frametitle={%
                    \tikz[baseline=(current bounding box.east),inner xsep = 5mm,inner ysep=1mm]
                    \node[anchor=east,rectangle,fill=defineblue]
                    {\strut\fonttextsc Definition~\thedefinition:~#1};}}%
    }%
...
\newenvironment{lemma}[1][]{%
    ...
    {\mdfsetup{%
            frametitle={%
                    ...
                    {\strut\fonttextsc Lemma~\thelemma};}}
    }%
    {\mdfsetup{%
            frametitle={%
                    \tikz[baseline=(current bounding box.east),inner xsep = 5mm,inner ysep=1mm]
                    \node[anchor=east,rectangle,fill=lemmayellow]
                    {\strut\fonttextsc Lemma~\thelemma:~#1};}}%
    }%
...
\newenvironment{proposition}[1][]{%
    ...
    {\mdfsetup{%
            frametitle={%
                    ...
                    {\strut\fonttextsc Proposition~\theproposition};}}
    }%
    {\mdfsetup{%
            frametitle={%
                    \tikz[baseline=(current bounding box.east),inner xsep = 5mm,inner ysep=1mm]
                    \node[anchor=east,rectangle,fill=propositionmint]
                    {\strut\fonttextsc Proposition~\theproposition:~#1};}}%
    }%
